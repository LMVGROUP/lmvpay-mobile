      ...
      <Animated.View style={[styles.successModalOverlay, { opacity: opacityAnim }]}>
        <Animated.View style={[
          ...
          <Text style={styles.successSubtitle}>
            Your Business loan application for ₹{loanAmount ? parseInt(loanAmount.replace(/,/g, '')).toLocaleString('en-IN') : '0'} has been successfully submitted.
          </Text>
...
// Main Component
export default function BusinessLoanDetails() {
  ...
  const createAPIPayload = () => {
    return {
      ...
      work_experience: formData.yearsInBusiness,
      mobile: formData.mobileNumber,
      email: formData.emailAddress.toLowerCase(),
      lead_type: 'LOAN',
      created_by_type: 'CUSTOMER',
      product_type: 'LOAN',
      product_sub_type: 'BUSINESS LOAN',
      lead_source: 'MOBILE'
    };
  };
        ...
        <View style={styles.content}>
          ...
          <View style={styles.field}>
            <View style={styles.labelContainer}>
              <FontAwesome5 name="money-check-alt" size={16} color="#1a3d5c" />
              <Text style={styles.label}>
                Annual Turn Over <Text style={styles.required}>*</Text>
              </Text>
            </View>
            <View style={styles.inputContainer}>
              <Text style={styles.currencySymbol}>₹</Text>
              <TextInput
                ...
                onChangeText={(value) => updateFormData('annualTurnOver', value)} 
          ...
          <View style={styles.field}>
            <View style={styles.labelContainer}>
              <FontAwesome5 name="money-check-alt" size={16} color="#1a3d5c" />
              <Text style={styles.label}>
                Years in business <Text style={styles.required}>*</Text>
              </Text>
            </View>
            <View style={styles.inputContainer}>
              <Text style={styles.currencySymbol}>₹</Text>
              <TextInput
               ...
               onChangeText={(value) => updateFormData('yearsInBusiness', value)} 
