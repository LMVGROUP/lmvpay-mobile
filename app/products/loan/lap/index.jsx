      ...
      <Animated.View style={[styles.successModalOverlay, { opacity: opacityAnim }]}>
        <Animated.View style={[
          ...
          <Text style={styles.successSubtitle}>
            Your Lap loan application for ₹{loanAmount ? parseInt(loanAmount.replace(/,/g, '')).toLocaleString('en-IN') : '0'} has been successfully submitted.
          </Text>
...
// Main Component
export default function LapLoanDetails() {
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      >
        ...
        <View style={styles.headerContent}>
          <Text style={styles.headerTitle}>Lap Loan Application</Text>
