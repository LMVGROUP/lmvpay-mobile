      ...
      <Animated.View style={[styles.successModalOverlay, { opacity: opacityAnim }]}>
        <Animated.View style={[
          ...
          <Text style={styles.successSubtitle}>
            Your Personal loan application for ₹{loanAmount ? parseInt(loanAmount.replace(/,/g, '')).toLocaleString('en-IN') : '0'} has been successfully submitted.
          </Text>
...
// Main Component
export default function PersonalLoanDetails() {
  ...
  const createAPIPayload = () => {
    return {
     ...
     salary : formData.monthlyIncome,
      ...
      product_type: 'LOAN',
      product_sub_type: 'PERSONAL LOAN',
      lead_source: 'MOBILE'
    };
  };
        ...
        <View style={styles.content}>
          ...
          <View style={styles.section}>
            ...
            <Dropdown
              ...
              onSelect={(value) => updateFormData('employeeType', value)}
              required
          ...
          <View style={styles.field}>
            <View style={styles.labelContainer}>
              <FontAwesome5 name="money-check-alt" size={16} color="#1a3d5c" />
              <Text style={styles.label}>
                Monthly Income <Text style={styles.required}>*</Text>
              </Text>
            </View>
            <View style={styles.inputContainer}>
              <Text style={styles.currencySymbol}>₹</Text>
